    ...
    <section id="contact" className="get-started">
      <div className="container">
        <div className="row text-center">
          <h1 className="display-3 fw-bold text-capitalize">Let's discuss how we can grow your business</h1>
          <div className="heading-line"></div>
          <p className="lh-lg">
            Get started with Verionyx Solutions today by filling out the contact form below.
          </p>
        </div>
        ...
        <div className="row text-white">
          <div className="col-12 col-lg-6 gradient shadow p-3">
            <div className="cta-info w-100">
              ...
              <p className="lh-lg">
              We're eager to hear about your project and explore how our team can help you achieve your goals. Please fill out the contact form, and we'll get in touch to schedule a meeting at your earliest convenience.
              </p>
